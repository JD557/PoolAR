...
main: main.cpp model.o tiny_obj_loader.o
	g++ main.cpp model.cpp tiny_obj_loader.cpp  -o main $(CFLAG) $(LDFLAG) $(LIBS)

model.o: model.cpp tiny_obj_loader.o
	g++ -c model.cpp tiny_obj_loader.o -o model.o $(CFLAG)
